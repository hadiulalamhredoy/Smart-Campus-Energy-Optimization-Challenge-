...
------------------------------------------------------------------------
1. Python 3.9+ installed on your environment.
...
1. Service health check endpoint (/health)
2. Batch operator note parsing endpoint (/api/v1/interpret-notes)
